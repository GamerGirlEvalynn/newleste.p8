  ...
  draw=function(this)
    ...
    if #disp_shapes==0 then
      ...
      for x=this.x, this.right() do
        local y=this.y
        local d,dx,dy,ds=displace(vector(x,y))
        d=max((4-d), 0)
        rectfill(x+dx*d*ds,y+dy*d*ds,x+dx*d*ds,y+dy*d*ds,7)
        y=this.bottom()
        d,dx,dy,ds=displace(vector(x,y))
        d=max((4-d), 0)
        rectfill(x+dx*d*ds,y+dy*d*ds,x+dx*d*ds,y+dy*d*ds,7)
      end
      for y = this.y, this.bottom() do
        local x=this.x
        local d,dx,dy,ds=displace(vector(x,y))
        d=max((4-d), 0)
        rectfill(x+dx*d*ds,y+dy*d*ds,x+dx*d*ds,y+dy*d*ds,7)
    ...
    foreach(this.particles, function(p)
        ...
        local d,dx,dy,ds=displace(vector(p.x,p.y))
        d=max((6-d), 0)
        rectfill(p.x+dx*d*ds,p.y+dy*d*ds,p.x+dx*d*ds,p.y+dy*d*ds,p.c)
      end)
  end 
}
...
function create_disp_shape(x,y)
  add(disp_shapes, {pos=vector(x,y),r=0})
end

function update_disp_shapes()
...
function displace(p)
  local d,x,y,s = 128,0,0,0
  for i in all(disp_shapes) do
    local dt,xt,yt = sdg_circ(p, i.pos, i.r)
    if dt<d then
      d,x,y,s=dt,xt,yt,(15-i.r)/15
    end
  end
  return d,x,y,s
end

function sdg_circ(p, origin, r)
  local po = vec_sub(p,origin)
  local d = vec_len(po)
  local g = vector(po.x/d, po.y/d)
  d-=r
  return abs(d), sign(d)*g.x, sign(d)*g.y
end
...

...

...

__sfx__
